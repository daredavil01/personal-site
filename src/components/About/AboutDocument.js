  ...
  return (
    <div className="flex flex-col gap-12 w-full max-w-3xl mx-auto">
      <header className="mb-4">
        <p className="font-label text-xs uppercase tracking-[0.3em] text-secondary mb-4 font-bold">Sanket Tambare</p>
        ...
        <p className="font-label text-sm text-stone-400 dark:text-stone-500 italic block">
          (in about {count} words)
        </p>
      </header>
      <div className="bg-secondary/[0.03] dark:bg-secondary/[0.05] border border-secondary/10 dark:border-secondary/20 p-8 md:p-12 rounded-xl">
