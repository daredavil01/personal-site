    ...
    >
      <article className="max-w-4xl">
        <header className="mb-12">
          ...
          <p className="font-label text-xs uppercase tracking-[0.3em] text-stone-400 dark:text-stone-500 font-medium">
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h3 className="font-headline text-lg font-bold text-stone-800 dark:text-stone-100 mb-2 group-hover:text-secondary transition-colors uppercase tracking-widest">
                      100 Days To Offload
                    </h3>
                    <p className="text-stone-400 dark:text-stone-500 text-xs italic mb-4">Can I publish 100 posts on blog in a year?</p>
                    <div className="flex items-center gap-2">
                        <span className="px-2 py-1 bg-stone-50 dark:bg-stone-800 text-[9px] text-stone-400 dark:text-stone-500 font-label uppercase tracking-wider rounded">Started on: 2025-01-22</span>
                    </div>
                  </div>
                </div>
              </Link>
          ...
          {/* Stats Section */}
          <section>
            <h2 className="font-label text-[10px] uppercase tracking-[0.2em] text-stone-900 dark:text-stone-300 font-bold mb-6">Stats</h2>
            <div className="bg-white dark:bg-stone-900 p-8 rounded-xl border border-stone-100 dark:border-stone-800 shadow-sm">
                <div className="flex flex-col items-center">
                    <span className="text-3xl font-headline font-bold text-secondary mb-1">1</span>
                    <span className="font-label text-[9px] uppercase tracking-[0.2em] text-stone-400 dark:text-stone-500">Total Challenges</span>
                </div>
            </div>
          </section>
        </div>
