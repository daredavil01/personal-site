...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/presentations", label: "Presentations", icon: Presentation, resource: "presentations" },
      ...
      { to: "/admin/changelog", label: "Changelog", icon: History, resource: "changelog" },
      { to: "/admin/changelog/sync", label: "Changelog sync", icon: RefreshCw },
    ],
  },
  {
    id: "now",
