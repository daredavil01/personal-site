...
const posts = [
  ...
  {
    id: 3,
    title: "Where things took turn for public policy!",
    tags: [
      "Public Policy",
      "Technology Policy",
    ],
  ...
  },
  {
    ...
    slideImages: [
      ...
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/6_2.webp`,
        caption: "Slide 2",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/6_3.webp`,
        caption: "Slide 3",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/6_4.webp`,
        caption: "Slide 4",
      },
      {
      ...
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/6_7.webp`,
        caption: "Slide 7",
      },
      {
      ...
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/6_10.webp`,
        caption: "Slide 10",
      },
    ],
  },
  {
    id: 6,
    title: "Another NIRMAN visit...!",
    tags: [
      "SEARCH",
      "NIRMAN",
    ],
    caption: "It feels good to be somewhere beautiful!❣️ Glad I could be there!❤️‍🔥 #SEARCH #Nirman🌱",
    slideImages: [
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/7_1.webp`,
        caption: "Slide 1",
      },
      {
  ...
  {
    id: 7,
    title: "Some glimpse from Marathons!",
    tags: [
      "NDA Matathon",
      "Marathons",
      "Running",
  ...
  },
  {
    ...
    slideImages: [
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/9_1.webp`,
        caption: "Slide 9",
      },
    ],
  },
  ...
  {
    id: 10,
    title: "Wardha Diaries!",
    tags: [
      "Travel Stories",
    ],
    caption: "#wardhadiaries❤ #fewGoodClicks🤠 #latepost🫠 Some trips help you to realise the true self in you, invoke that genuine self, and give you the feeling of unique opportunity of peaking into lives of few ordinary places, people like sevagram ashram, where Gandhiji resided, the Vinoba Ashram and few enthusiast folks like @bhosale270 , @suyash.toshniwal and many more! One thing that still takes over the enchanted mind is the essence of presence of Mahatma in a place and the delicacy, etiquette with which, the decorum is maintained till date via Sarm-dharm-pratharna and Bhajan at evening!✌️ You get to enjoy the peace, the greatness and most importantly serenity of Bapu!🤍 It was one such trip with some beautiful souls!❣️",
    slideImages: [
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_1.webp`,
        caption: "Slide 1",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_2.webp`,
        caption: "Slide 2",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_3.webp`,
        caption: "Slide 3",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_4.webp`,
        caption: "Slide 4",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_5.webp`,
        caption: "Slide 5",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_6.webp`,
        caption: "Slide 6",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_7.webp`,
        caption: "Slide 7",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_8.webp`,
        caption: "Slide 8",
      },
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/11_9.webp`,
        caption: "Slide 9",
      },
    ],
  },
  {
    ...
    slideImages: [
      {
        url: `${process.env.PUBLIC_URL}/images/insta_posts/21.webp`,
        caption: "Slide 1",
      },
    ],
  },
