...
const books = [
  ...
  {
    id: 15,
    title: "On the Opportunities and Risks of Foundational Models",
    ...
    blog_link: null,
    blog_platform: null,
    description: "On the Opportunities and Risks of Foundational Models is a comprehensive report on the state of large-scale AI. Researchers from Stanford explore the technical, social, and ethical dimensions of models like GPT-3. It highlights the transformative potential and the significant risks involved.",
    tags: [
      "Politics",
      "AI",
      "Technology",
  ...
  },
  {
    ...
    language: "English",
    translator: null,
    blog_link: "https://sankettambare.substack.com/p/book-review-nitopadesha",
    blog_platform: "Substack",
    description: "The Nitopadesha (Repeat entry) - Nitin Pai's collection of fables on citizenship. (Note: ID 29 and 13 seem to be the same book title, processing accordingly).",
    tags: [
      "Technology",
      "Public-Policy",
      "AI"
  ...
  },
  {
    ...
    language: "English",
    translator: null,
    blog_link: "https://daredavil453624413.wordpress.com/2020/08/18/book-review-1984-george-orwell/",
    blog_platform: "WordPress",
    description: "1984 (Repeat entry with review link) - George Orwell's classic dystopian novel about a totalitarian regime.",
    tags: [
      "Fiction"
    ]
  },
