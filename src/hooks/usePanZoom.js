...
//
// Promoted from src/components/MindMap/ for the atlas map hub (§4.6); a
// re-export shim remains at the old path. Ownership rule (§4.6): this hook
// owns the SVG viewBox; GSAP only ever touches element transforms/opacity —
// never both on the same value, so animations can't fight.
